...
class AppInteractionService:
    ...
    def __init__(self,
        ...
        print("asa--->"+self.asa_delegate_authority_address)
        ...
        print("self algo--->"+self.algo_delegate_authority_address)
    ...
    def execute_bidding(self,
        ...
        print("bidder_address"+bidder_address)
        print("algo dele"+self.algo_delegate_authority_address)
        ...
        print(biding_payment_txn,amount)
